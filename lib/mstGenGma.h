...
void mstSetCompressType(int compType);
...
void getGamutVertice(int gamutType, int RGBW, double *sx, double *sy);
...
void setBrightModifySettings(int brightModifyMode, int rightLevel);
