...
#define POSTGMA_SETOFFSETH(offset) (writeDeltaEPostGammacmd.burndata[POSTGMA_OFFSET_H] = ((offset)&0xFF00)>>8)
#define POSTGMA_SETOFFSETL(offset) (writeDeltaEPostGammacmd.burndata[POSTGMA_OFFSET_L] = ((offset)&0X00FF))
